...
elixir(function (mix) {
    ...
    mix.copy('node_modules/bootstrap-growl/bootstrap-notify.min.js', 'public/js/bootstrap-notify.min.js');
    ...
    mix.scripts(['media-manager.js', 'iconmoo.json'], 'public/js/media-manager.js')
